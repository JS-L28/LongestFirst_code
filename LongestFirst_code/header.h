...
const int PrefixSize = 6; //number of digits indicating length(size) of prefix. 
...
const int Ha = 10; //bits of hash separated (Hash Table)
/*
const int A = 0;
const int B = 4;
const int C = 8; //3
